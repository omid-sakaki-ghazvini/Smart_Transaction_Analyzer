...
with tab3:
    st.header("پرس‌وجوی هوشمند (ترکیبی)")
    st.markdown("""
    **نمونه پرس‌وجوهای پشتیبانی شده:**
    - کل هزینه‌های من چقدر است؟
    - هزینه‌های غذا در فروردین چقدر بود؟
    - تراکنش‌های حمل و نقل را نشان بده
    - میانگین هزینه‌های من چقدر است؟
    - تعداد تراکنش‌های ماه گذشته
    - دسته‌بندی هزینه‌های من چگونه است؟
    - آخرین تراکنش‌های من را نشان بده
    """)
